...
<form:form method="post" modelAttribute="searchForm" action="search" id="searchForm" cssClass="form-horizontal"  autocomplete="off">
    ...
    <div class="col-md-3">    
        ...
        <div class="control-group<c:if test="${not empty titleErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input class="form-control" path="title" id="field-title" tabindex="1" maxlength="45" placeholder="Title"/>
        ...
        <div class="control-group<c:if test="${not empty streetErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input class="form-control" path="street" id="field-title" tabindex="2" maxlength="35" placeholder="Street"/>
        ...
        <div class="control-group<c:if test="${not empty streetNumberErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input class="form-control" path="streetNumber" id="field-streetNumber" tabindex="2" maxlength="35" placeholder="StreetNumber"/>
        ...
        <div class="control-group<c:if test="${not empty cityErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input class="form-control" path="city" id="field-city" tabindex="2" maxlength="35" placeholder="City"/>
        ...
        <div class="control-group<c:if test="${not empty descriptionErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input class="form-control" path="zipCode" id="field-zipCode" tabindex="3" maxlength="35" placeholder="Zip-Code"/>
        ...
        <div class="control-group<c:if test="${not empty descriptionErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input class="form-control" path="price" id="field-price" tabindex="3" maxlength="35" placeholder="Price"/>
        ...
        <div class="control-group<c:if test="${not empty descriptionErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input class="form-control" path="nrOfRoomMates" id="field-nrOfRoomMates" tabindex="3" maxlength="35" placeholder="Number of Roommates"/>
