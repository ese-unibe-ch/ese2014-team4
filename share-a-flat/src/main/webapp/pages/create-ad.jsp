...
<form:form enctype="multipart/form-data" method="post" modelAttribute="adForm" action="submitAd" id="adForm" cssClass="form-horizontal"  autocomplete="off">
    ...
    <div class="col-md-3">    
        ...
        <div class="control-group<c:if test="${not empty streetErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="street" id="field-street" class="form-control" tabindex="4" maxlength="35" placeholder="Street"/>
        ...
        <div class="control-group<c:if test="${not empty streetNumberErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="streetNumber" id="field-streetNumber" class="form-control" tabindex="5" maxlength="35" placeholder="StreetNumber"/>
        ...
        <div class="control-group<c:if test="${not empty cityErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="city" id="field-city" class="form-control" tabindex="6" maxlength="35" placeholder="City"/>
        ...
        <div class="control-group<c:if test="${not empty zipCodeErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="zipCode" id="field-zipCode" class="form-control" tabindex="7" maxlength="35" placeholder="Zip-Code"/>
        ...
        <div class="control-group<c:if test="${not empty sizeErrors}"> error</c:if>">
            <label class="control-label" for="field-size">Size of Room or Flat (m<sup>2</sup>):</label>

            <div class="controls">
                <form:input path="size" id="field-size" class="form-control" tabindex="8" maxlength="45" placeholder="Size"/>
        ...
        <div class="control-group<c:if test="${not empty nrOfRoomsErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="nrOfRooms" id="field-nrOfRooms" class="form-control" tabindex="9" maxlength="45" placeholder="nrOfRooms"/>
        ...
        <div class="control-group<c:if test="${not empty priceErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:input path="price" id="field-price" class="form-control" tabindex="10" maxlength="35" placeholder="Price"/>
        ...
        <div class="control-group<c:if test="${not empty nrOfRoomMatesErrors}"> error</c:if>">
            <label class="control-label" for="field-nrOfRoomMates">Number of RoomMates:</label>
            <div class="controls">
                <form:input path="nrOfRoomMates" id="field-nrOfRoomMates" class="form-control" tabindex="11" maxlength="35" placeholder="Number of Roommates"/>
...
<!-- middle column -->
	...
	<div class="layout-content-column">
        ...
        <div class="control-group<c:if test="${not empty descriptionErrors}"> error</c:if>">
            ...
            <div class="controls">
                <form:textarea path="description" id="field-description" style="width:483px; height:121px"tabindex="12" placeholder="Description"/>
	    ...
	    <div class="form-actions">
            ...
            <button type="button" onclick="history.go(-1);return true" class=" btn" tabindex="14">Cancel</button>
        </div>
	</div>
</div>
</form:form>
