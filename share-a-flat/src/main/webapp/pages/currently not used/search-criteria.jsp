...
<body onload="FocusOnInput()">
	...
	<form:form enctype="multipart/form-data" method="post"
		modelAttribute="searchForm" action="search"
			...
			<div class="col-md-12" style="padding-left: 0px; padding-right: 3px">
				...
				<div
					...
					<div class="controls">
						...
						<form:errors type="text" path="cityOrZip" cssClass="help-inline"
							element="span" />
					...
					<div
						...
						<div class="controls">
							<form:input type="number" min="0" max="100000" step="1"
								...
								tabindex="4" maxlength="35" placeholder="Min-Price" />
					...
					<div
						...
						<div class="controls">
							<form:input type="number" min="0" max="100000" step="1"
								...
								tabindex="5" maxlength="35" placeholder="Max-Price" />
				...
				<div
					...
					<div class="controls">
						<form:input type="number" min="0" max="100" step="0.5"
							...
							tabindex="6" maxlength="35" placeholder="Number of Rooms"
							disabled="true" />
				...
				<div
					...
					<div class="controls">
						<form:input type="date" class="form-control" path="availableDate"
							id="field-availableDate" placeholder="DD-MM-YYYY" />
