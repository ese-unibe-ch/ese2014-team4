...
<div class="container">
   ...
   <!-- TODO password does not work yet (is in wrong format) -->
	        ...
	        <div class="form-group<c:if test="${not empty passwordErrors}">error</c:if>">
	            <label class="col-lg-3 control-label" for="field-password">New Password:</label>
	            <div class="col-lg-8">
	                <form:password path="password" class="form-control"  id="field-password" tabindex="3" maxlength="35" placeholder="Password" />
	         ...
	         <div class="form-group<c:if test="${not empty passwordRepeatedErrors}"> error</c:if>">
	            <label class="col-lg-3 control-label" for="field-passwordRepeated">Repeat new password:</label>
	            <div class="col-lg-8">
        ...
        <div class="form-group<c:if test="${not empty phoneNumberErrors}"> error</c:if>">
            ...
            <div class="col-lg-8">
                <form:input class="form-control" path="phoneNumber" id="field-phoneNumber" type="number" min="" max="9999999999999" step="1" pattern="[0-9]{0,13}"  tabindex="5" maxlength="45" value="${user.profile.phoneNumber}" placeholder="phone number"/>
        ...
        <div class="form-group<c:if test="${not empty sexErrors}"> error</c:if>">
            ...
            <div class="radio">
                <label><input type="radio" name="sex" id="male" tabindex="7" value="M" ${checkedM}>Male</label>
                <label><input type="radio" name="sex" id="female" tabindex="8" value="F" ${checkedF}>Female</label><br><br>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8">
              <form:input class="form-control" value="${user.profile.userDescription}" type="text" path="userDescription"  tabindex="8" placeholder="describe yourself"/>
              <form:errors path="userDescription" cssClass="help-inline" element="span" />
            </div>
        </div>
