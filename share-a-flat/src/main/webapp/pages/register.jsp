	...
	<div class="transbox">
		...
		<form:form method="post" modelAttribute="signupForm" action="createAccount" onsubmit="return isValid()" id="signupForm" cssClass="form-horizontal"  autocomplete="off">
	        ...
	        <div class="control-group<c:if test="${not empty usernameErrors}"> error</c:if>">
	            <label class="control-label" for="field-userName"><b>User Name*</b></label>
	            <div class="controls">
	        ...
	        <div class="control-group<c:if test="${not empty passwordErrors}"> error</c:if>">
	         ...
	         <div class="control-group<c:if test="${not empty passwordRepeatedErrors}"> error</c:if>">
	            <label class="control-label" for="field-passwordRepeated"><b>Repeat password*</b></label>
	            <div class="controls">
	        ...
	        <div class="form-actions">
	            ...
	            <button type="button" onclick="history.go(-1);return true" tabindex="6" class=" btn">Cancel</button>
	        </div>
